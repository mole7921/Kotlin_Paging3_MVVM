...
import com.enzo.architecture.databinding.ItemUnsplashItemBinding
...
class UnsplashPhotoAdapter(private val listener: OnItemClickListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PhotoViewHolder {
        val binding = ItemUnsplashItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
   ...
   inner class PhotoViewHolder(private val binding: ItemUnsplashItemBinding) :
